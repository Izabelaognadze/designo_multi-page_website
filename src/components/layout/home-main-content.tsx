...
export const HomeMainContent = () => {
  return (
    <div className="overflow-hidden md:rounded-[15px] bg-clrPinkDark text-white max-w-[1111px] mx-auto items-center flex flex-col lg:flex-row md:mx-10 lg:mx-auto">
